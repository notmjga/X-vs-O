...
function gameOver(a) {
    var gameOverAlertElement = "<b>JUEGO TERMINADO </b><br><br> Jugador " + span[a].dataset.player.toUpperCase() + ' Ganó!!! <br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b>Ninguno ganó!!</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
